...
analysis3 = evaluator.analysis_3_per_dg_model(ds_model, n_learning=0, n_train=1000,n_test=1000, n_true_repetitions=10, n_learning_repititions=10, n_sl_repititions=10)
